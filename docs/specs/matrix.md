...
| [DS003](specsLoader.html?spec=DS003-agent-inventory.md) | Agent Inventory | [[status:planned]] | copilot-agents-team | Defines the tagged research relay inventory, provider-backed backend tags, and default enablement posture. |
...
| [DS005](specsLoader.html?spec=DS005-research-relay-agent.md) | Research Relay Agent (researchRelay) | [[status:planned]] | copilot-agents-team | Defines the Explorer-facing tagged research-task relay under the `researchRelay` agent id. |
...
| [DS010](specsLoader.html?spec=DS010-achilles-cli-launch-integration.md) | AchillesCLI Tagged Chat Integration | [[status:implemented]] | copilot-agents-team | Defines how AchillesCLI Copilot chat participates in tagged research task dispatch. |
...
| [DS012](specsLoader.html?spec=DS012-tagged-research-chat-relay.md) | Tagged Research Chat Relay | [[status:planned]] | copilot-agents-team | Defines the Copilot/WebMeet @tag relay contract, provider routing, local sandbox execution, and natural-language reply invariant. |
